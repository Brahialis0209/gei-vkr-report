...
%%
%%
\newcommand{\Author}{Р.А.\,Темиргалиев} % И.О. Фамилия автора 
\newcommand{\AuthorFull}{Темиргалиев Рафаэль Анварович} % Фамилия Имя Отчество автора
...
\newcommand{\AuthorPhone}{+7-981-788-29-01} % номер телефорна автора для оперативной связи  
...
%%
%%
\renewcommand{\thesisTitle}{Разработка метода определения экспрессии генов по изображениям мозга плодовой мушки}
...
%%
%%
\newcommand{\group}{3630102/70401} % заменить вместо N номер группы
